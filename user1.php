        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <a href="deleteuser.php?acdelete=<?php echo $u_id; ?>"> <button type="submit" name="submit"
                  class="btn btn-danger btn-sm">Delete Account</button></a>
            </div>
          </div>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form action="update-user1.php" class="needs-validation" method="POST" enctype="multipart/form-data"
                    novalidate>
