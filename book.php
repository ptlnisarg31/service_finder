                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <form action="confirm.php?W_id=<?php echo $id; ?>" method="post" class="order">
                            ...
                            <fieldset>
                                ...
                                <input type="text" name="full-name" placeholder="E.g. Nisarg Patel" class="input-responsive"
                                    required>

                                <div class="order-label">Phone Number</div>
                                <input type="number" name="contact" placeholder="E.g. 9843xxxxxx" class="input-responsive"
                                    maxlength="10" required>

                                <div class="order-label">Email</div>
                                <input type="email" name="email" placeholder="E.g. hi@nisargpatel.com" class="input-responsive"
                                    required>
